          ...
          {streamState.streams.map((stream) => (
            ...
            <Grid item key={stream.streamId} className={classes.stream} component={Link} to={ "/stream/" + stream.streamId }>
              ...
              <Grid container direction="column" alignItems="center" spacing={8}>
                ...
                <img src={stream.streaming ? "https://stream.jrdn.tech/thumbnails/"+stream.streamId+".png" : "https://multimedia.europarl.europa.eu/o/europarltv-theme/images/europarltv/media-default-thumbnail-url-video.png"} className={classes.image} />
                <Typography variant="body1" gutterBottom align="center">
